<?php 
	class controller_add_edit_category_mkpk{
		//khai bao bien model
		public $model;
		public function __construct(){
			...
			switch($act){
				case "edit":
					...
					$form_action = "admin.php?controller=add_edit_category_mkpk&act=do_edit&id=$id";
					//load view
					include "view/backend/view_add_edit_category_mkpk.php";
				break;
				case "do_edit":
					$c_name = $_POST["c_name"];
					//update c_name
				...
				break;
				case "add":
					$form_action = "admin.php?controller=add_edit_category_mkpk&act=do_add";
					//load view
					include "view/backend/view_add_edit_category_mkpk.php";
				break;
				case "do_add":
	...
	new controller_add_edit_category_mkpk();
 ?>