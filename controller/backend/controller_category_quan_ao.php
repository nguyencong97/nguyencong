<?php 
	class controller_category_quan_ao{
		public $model;
		public function __construct(){
			...
			$arr = $this->model->get_all("select * from category_product where type=0 order by id_product asc limit $from,$record_per_page");
			//---------
			//load view
			include "view/backend/view_category_quan_ao.php";
			
		}
	}
	new controller_category_quan_ao();
