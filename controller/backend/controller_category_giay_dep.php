<?php 
	class controller_category_giay_dep{
		public $model;
		public function __construct(){
			...
			$arr = $this->model->get_all("select * from category_product where type=2 order by id_product asc limit $from,$record_per_page");
			//---------
			//load view
			include "view/backend/view_category_giay_dep.php";
			
		}
	}
	new controller_category_giay_dep();
