<?php 
	class controller_add_edit_giay_dep{
		//khai bao bien model
		public $model;
		public function __construct(){
			...
			switch($act){
				case "edit":
					$form_action = "admin.php?controller=add_edit_giay_dep&act=do_edit&id=$id";
					//lay mot ban ghi tuong ung voi id truyen vao
					$arr = $this->model->get_a_record("select * from product where pk_product_id=$id");
					//load view
					include "view/backend/view_add_edit_giay_dep.php";
				break;
				case "do_edit":
					$c_name = $_POST['c_name'];
				...
				$this->model->execute("update product set c_img='$c_img' where pk_product_id=$id");
					...
					header("location:admin.php?controller=giay_dep");
				break;
				case "add":
					$form_action = "admin.php?controller=add_edit_giay_dep&act=do_add";
					include "view/backend/view_add_edit_giay_dep.php";
					break;
				case "do_add";
					$c_name = $_POST['c_name'];
	...
	new controller_add_edit_giay_dep();
 ?>