<div id="content">
    <div class="breadcrumb"> &nbsp;<a href="trang-chu">Home&nbsp;</a> » &nbsp;<a href="trang-chu">Search</a> </div>
    ...
    <div class="product-list">
      <?php 
        foreach ($arr as $rows) {
       ?>
      <div class="box-product"> <a class="image" href="name/<?php echo remove_unicode($rows->c_name) ?>/id/<?php echo $rows->pk_product_id; ?>" title="View more"> <img src="public/upload/product/<?php echo $rows->c_img; ?>" alt=""> </a>
    ...
    <div class="container">
     <ul class="pagination">
        ...
        <?php 
         ...
         ?>
        <li class="page-item"><a href="index.php?controller=timkiem&key=<?php echo $key ?>&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
        <?php } ?>
      </ul> 
    </div>
  </div>
