				...
				<form method="post" action="<?php echo $form_action; ?>">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-10">
								<input required type="email" name="c_email" value="<?php echo isset($arr->c_email)?$arr->c_email:''; ?>" <?php if(isset($arr->c_email)){ ?> disabled <?php }else{ ?> required <?php } ?> class="form-control">
							</div>
						</div>
					</div>
					<!-- end form group -->
