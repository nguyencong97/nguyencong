<div class="row justify-content-center">
	<div class="col-md-12">
		...
		<div style="margin:15px 0px">
			<a href="admin.php?controller=add_edit_mkpk&act=add" class="btn btn-primary">Add</a>
		</div>
			...
			<div class="card card-header bg-primary text-white" style="padding:7px !important;">Login</div>
				...
				<table class="table table-hover table-bordered">
					...
					<tr>
						...
						<td style="text-align: center;">
						<a href="admin.php?controller=add_edit_mkpk&act=edit&id=<?php echo $rows->pk_product_id; ?>">Edit</a>&nbsp;&nbsp;
						<a href="admin.php?controller=mkpk&act=delete&id=<?php echo $rows->pk_product_id; ?>">Delete</a>
						</td>
					</tr>
				<?php } ?>
				</table>
				...
				<div class="card-footer" style="padding:7px !important">
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link" href="admin.php?controller=mkpk&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
						<?php } ?>
					</ul>
				</div>
			</div>
